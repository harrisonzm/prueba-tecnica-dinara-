...
import { InscriptionCard } from './index';
...
describe('InscriptionCard', () => {
    ...
    it('renders the inscription details correctly', () => {
    ...
    it('calls the delete API and onDeleted callback when DELETE button is clicked', async () => {
